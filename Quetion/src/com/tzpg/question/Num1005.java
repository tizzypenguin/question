 ...
 */
public class Num1005 extends Thread{
	...
	public void run() {
		try {
			...
			for(int i = 0; i< testCase; i++) {
				String bnumNrnum = scan.nextLine();
				int bnum = Integer.parseInt(bnumNrnum.split(" ")[0]);
				int rnum = Integer.parseInt(bnumNrnum.split(" ")[1]);
